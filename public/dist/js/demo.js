...
$(function () {
    ...
    $demoSettings.append(
        ...
        + 'Expansión Barra Lateral'
        + '</label>'
        + '<p>Dejar que la barra lateral se expanda al pasar el mouse</p>'
        + '</div>'
        // Control Sidebar Toggle
        // + '<div class="form-group">'
        // + '<label class="control-sidebar-subheading">'
        // + '<input type="checkbox"data-controlsidebar="control-sidebar-open"class="pull-right" checked/> '
